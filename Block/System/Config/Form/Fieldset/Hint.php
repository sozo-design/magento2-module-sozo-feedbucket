...
namespace Sozo\Feedbucket\Block\System\Config\Form\Fieldset;
...
class Hint extends Template implements RendererInterface
{
     ...
     * @var string
     */
    protected $_template = 'Sozo_Feedbucket::system/config/fieldset/hint.phtml';
